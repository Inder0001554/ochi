...
function Footer() {
  return (
    <div className='w-full min-h-screen flex flex-col lg:flex-row gap-10 sm:gap-12 lg:gap-5 bg-zinc-900 p-8 sm:p-14 md:p-16 lg:p-20 text-white'>
      
      {/* LEFT SIDE */}
      <div className='w-full lg:w-1/2 h-full flex flex-col justify-between'>
        <div className='heading'>
          <h1 className='text-[10vw] sm:text-[7vw] md:text-[6vw] lg:text-[5vw] uppercase font-semibold leading-none -mb-2 sm:-mb-3'>
            Eye-
          </h1>
          <h1 className='text-[10vw] sm:text-[7vw] md:text-[6vw] lg:text-[5vw] uppercase font-semibold leading-none -mb-6 sm:-mb-8 md:-mb-10'>
            OPening
          </h1>
        </div>
      ...
      <div className='w-full lg:w-1/2 flex flex-col justify-center'>
        ...
        <div className='dets mt-6 sm:mt-10 space-y-3 sm:space-y-4'>
          <a className='block text-lg sm:text-xl md:text-2xl font-light hover:underline' href='#'>Facebook</a>
          <a className='block text-lg sm:text-xl md:text-2xl font-light hover:underline' href='#'>Instagram</a>
          <a className='block text-lg sm:text-xl md:text-2xl font-light hover:underline' href='#'>Twitter</a>
        </div>
      </div>
    </div>
  )
