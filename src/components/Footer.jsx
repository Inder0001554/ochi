    ...
    <div className='w-full h-screen flex gap-5 bg-zinc-900 p-20'>
       <div className='w-1/2 h-full flex flex-col justify-between'>
              <div className='heading'>
                  <h1 className='text-[5vw] uppercase font-semibold leading-none -mb-3'>Eye-</h1>
                  <h1 className='text-[5vw] uppercase font-semibold leading-none -mb-10'>OPening</h1>
              </div>
       ...
       <div className='w-1/2'>
              <h1 className='text-[5vw] uppercase font-semibold leading-none -mb-3'>presentsions</h1>
